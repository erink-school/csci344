...
let token = null;
let username = "erink";   // change to your username :)
...
async function showPosts() {
    ...
    const postContainerEl = document.querySelector("#postsContainer");
    ...
    posts.forEach(post => {
        ...
        postContainerEl.insertAdjacentHTML("beforeend", htmlSnippet);
    });
}
            ...
            <div class="p-4">
                ...
                <div class="text-sm mb-3">
                    <p>
                        ...
                        ${post.alt_text} <button class="button">more</button>
                    </p>
                </div>
